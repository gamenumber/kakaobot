...
while True:
    ...
    #"(자동회신)현재 주인장이 외출중입니다. 나중에 꼼꼼하게 읽고 꼭 답변 드리겠습니다 (@_@)"
    #"(자동회신)현재 주인장이 식사중입니다. 나중에 꼼꼼하게 읽고 꼭 답변 드리겠습니다 (@_@)"
    #"(자동회신)현재 주인장이 샤워중입니다. 나중에 꼼꼼하게 읽고 꼭 답변 드리겠습니다 (@_@)"
    #"(자동회신)프로그램 테스트 중입니다 (@_@)"
